...
// #include <stdio.h>
// #include <string.h>
// #include "libft.h" // Assuming you have helper functions like ft_putendl_fd and ft_split

// // Function to check if a string represents a valid integer within the int range
